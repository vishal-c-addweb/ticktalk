...
class ProjectMilestoneController extends AccountBaseController
{
    ...
    public function store(StoreMilestone $request)
    {
        ...
        $this->logProjectActivity($project->id, ucwords($milestone->milestone_title) . ' - ' . __('messages.newMilestoneCreated'));
    ...
    public function update(StoreMilestone $request, $id)
    {
        ...
        $this->logProjectActivity($milestone->project_id, ucwords($milestone->milestone_title) . ' - ' . __('messages.milestoneUpdated'));
        return Reply::success(__('messages.milestoneSuccess'));
    }
    ...
    public function destroy($id)
    {
        ...
        $this->logProjectActivity($milestone->project_id, ucwords($milestone->milestone_title) . ' - ' . __('messages.milestoneDeleted'));
