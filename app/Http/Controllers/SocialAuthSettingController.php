...
class SocialAuthSettingController extends AccountBaseController
{
    ...
    public function update(UpdateRequest $request)
    {
        ...
        $socialAuth->rocket_chat_client_id = $request->rocket_chat_client_id;
        $socialAuth->rocket_chat_secret_secret_id = $request->rocket_chat_secret_secret_id;
        $socialAuth->rocket_chat_redirect_uri = $request->rocket_chat_redirect_uri;
        $socialAuth->rocket_chat_server_uri = $request->rocket_chat_server_uri;
        ($request->rocket_chat_status) ? $socialAuth->rocket_chat_status = 'enable' : $socialAuth->rocket_chat_status = 'disable';
        $socialAuth->save();
