...
class UpdateRequest extends CoreRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'rocket_chat_client_id' => 'required_if:rocket_chat_status,enable|max:100',
            'rocket_chat_secret_secret_id' => 'required_if:rocket_chat_status,enable|max:100',
            'rocket_chat_redirect_uri' => 'required_if:rocket_chat_status,enable|url',
            'rocket_chat_server_uri' => 'required_if:rocket_chat_status,enable|url',
        ];
    }
