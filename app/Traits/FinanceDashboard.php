...
trait FinanceDashboard
{
    ...
    public function financeDashboard()
    {
        ...
        // Total Expense
        $expenses = Expense::whereBetween(DB::raw('DATE(expenses.`created_at`)'), [$startDate, $endDate])
    ...
    public function invoiceOverviewChartData($startDate, $endDate)
    {
        ...
        $allInvoice = Invoice::whereBetween(DB::raw('DATE(`created_at`)'), [$startDate, $endDate])->get();
