            ...
            <div class="col-lg-12 col-md-12 ntfcn-tab-content-left w-100 p-20">
                ...
                <div class="row">
                    ...
                    {{-- rocket chat --}}
                      ...
                      <div class="col-md-12 mt-5">
                        <h4 class="mb-3 f-21 font-weight-normal text-capitalize">
                            <i class="far fa-comment-dots"></i> @lang('app.socialAuthSettings.rocketChat')
                        </h4>
                    </div>
                    <div class="col-lg-12 mb-2">
                        <x-forms.checkbox :fieldLabel="__('app.status')" fieldName="rocket_chat_status" fieldId="rocketChatButton"
                            fieldValue="enable" fieldRequired="true" :checked="$credentials->rocket_chat_status == 'enable'" />
                    </div>
                    <div class="col-lg-12 rocketChatSection @if ($credentials->rocket_chat_status !== 'enable') d-none @endif">
                        <div class="row">
                            <div class="col-lg-6">
                                <x-forms.text :fieldLabel="__('app.socialAuthSettings.rocketChatClientId')"
                                    fieldName="rocket_chat_client_id" fieldRequired="true" fieldId="rocket_chat_client_id"
                                    :fieldValue="$credentials->rocket_chat_client_id">
                                </x-forms.text>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <x-forms.label class="mt-3" fieldId="password" fieldRequired="true"
                                        :fieldLabel="__('app.socialAuthSettings.rocketChatSecret')">
                                    </x-forms.label>
                                    <x-forms.input-group>
                                        <input type="password" name="rocket_chat_secret_secret_id" id="rocket_chat_secret_secret_id"
                                            class="form-control height-35 f-14"
                                            value="{{ $credentials->rocket_chat_secret_secret_id }}">
                                        <x-slot name="preappend">
                                            <button type="button" data-toggle="tooltip"
                                                data-original-title="{{ __('messages.viewKey') }}"
                                                class="btn btn-outline-secondary border-grey height-35 toggle-password"><i
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <x-forms.text :fieldLabel="__('app.socialAuthSettings.rocketChatRedirectUri')"
                                    fieldName="rocket_chat_redirect_uri" fieldRequired="true" fieldId="rocket_chat_redirect_uri"
                                    :fieldValue="$credentials->rocket_chat_redirect_uri">
                                </x-forms.text>
                            </div>
                            <div class="col-lg-6">
                                <x-forms.text :fieldLabel="__('app.socialAuthSettings.rocketChatServerUri')"
                                    fieldName="rocket_chat_server_uri" fieldRequired="true" fieldId="rocket_chat_server_uri"
                                    :fieldValue="$credentials->rocket_chat_server_uri">
                                </x-forms.text>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        $('#rocketChatButton').on('change', function() {
            $('.rocketChatSection').toggleClass('d-none');
        });
