        ...
        <div class="d-flex">
            <div class="inv-action mr-3 mr-lg-3 mr-md-3 dropup">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" tabindex="0">
                    ...
                    @if ($invoice->status != 'paid' && $deleteInvoicePermission == 'all' || ($deleteInvoicePermission == 'added' && $invoice->added_by == user()->id))
                        <li>
            ...
            {{-- PAYMENT GATEWAY --}}
            @if (in_array('client', user_roles()) && $invoice->total > 0 && ($invoice->status == 'unpaid' || $invoice->status == 'partial') && ($credentials->paypal_status == 'active' || $credentials->stripe_status == 'active' || $credentials->razorpay_status == 'active'))
                <div class="inv-action mr-3 mr-lg-3 mr-md-3 dropup">
