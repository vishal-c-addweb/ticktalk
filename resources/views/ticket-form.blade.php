                            ...
                            <div class="row">
                                @foreach ($ticketFormFields as $item)
                                    ...
                                    @if($item->field_type == 'textarea')
                                        ...
                                        <div class="col-sm-6">
                                            <x-forms.textarea :fieldId="$item->field_name" :fieldLabel="__('modules.tickets.'.$item->field_name)" :fieldName="$item->field_name" :fieldRequired="$item->required == 1">
                                            </x-forms.textarea>
                                        </div>
                                    ...
                                    @elseif($item->field_type == 'select')
                                        ...
                                        @if($item->field_name == 'type')
                                            <div class="col-lg-4">
                                                <x-forms.select :fieldId="$item->field_name" :fieldLabel="__('modules.tickets.'.$item->field_name)" :fieldName="$item->field_name"
                                                    search="true" alignRight="true" :fieldRequired="$item->required == 1">
                                    ...
                                    @else
                                        <div class="col-md-6">
                                            <x-forms.text :fieldId="$item->field_name" :fieldLabel="__('modules.tickets.'.$item->field_name)"
