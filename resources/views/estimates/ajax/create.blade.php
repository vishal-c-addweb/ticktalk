                ...
                @else
                    <x-client-selection-dropdown :clients="$clients">
                        <x-slot name="conditions">
                            @if (isset($estimate) && $clientOpt->id == $estimate->client_id) selected @endif @if (request()->has('default_client') && request('default_client') == $clientOpt->id) @endif
                        </x-slot>
                                    ...
                                    <tr>
                                        ...
                                        <td width="40%" style="padding: 5px;">
                                            <table width="100%">
                                                <tbody>
                                                    <tr>
                                                        <td width="30%" class="c-inv-sub-padding">
                                                        ...
                                                        <td width="70%" align="left" class="c-inv-sub-padding">
                                                            <div
