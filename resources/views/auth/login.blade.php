                    ...
                    <div class="col-md-12 text-center">
                        <div class="login_box mx-auto rounded bg-white text-center">
                            ...
                            <div id="password-section"
                                ...
                                @if ($socialAuthSettings->rocket_chat_status == 'enable')
                                <a href="{{ url('/rocketlogin') }}" alt="RocketChat Login" class=" mt-2" style="border:0px solid #e8eef3;">
                                    <img src="{{ asset('rocketchatlogo.png') }}" alt="RocketChat Login"
