...
<div class="row py-5">
    <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
        @if (($addProjectMemberPermission == 'all' || $addProjectMemberPermission == 'added') && !$project->trashed())
                ...
                <x-table class="border-0 pb-3 admin-dash-table table-hover">
                    ...
                    @forelse($project->members as $key=>$member)
                        <tr id="row-{{ $member->id }}">
                            ...
                            @if($viewProjectHourlyRatePermission == 'all')
                                <td>
                                    @if ($editProjectMemberPermission == 'all' || ($editProjectMemberPermission == 'added' && user()->id == $member->added_by))
                            ...
                            <td class="text-right pr-20">
                                ...
                                && ($editProjectMemberPermission == 'all' || ($editProjectMemberPermission == 'added' && user()->id == $member->added_by)))
                                    <x-forms.button-secondary data-row-id="{{ $member->id }}" icon="times"
                                        class="remove-admin">
                                        @lang('app.remove') @lang('app.projectAdmin')</x-forms.button-secondary>
                                @endif

                                @if ($deleteProjectMemberPermission == 'all' || ($deleteProjectMemberPermission == 'added' && user()->id == $member->added_by))
