    ...
    <div class="col-sm-12">
        <x-form id="save-data-form" method="PUT">
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    <div class="col-md-3">
                        <x-forms.select fieldId="salutation" fieldName="salutation"
                            ...
                            @foreach ($salutations as $salutation)
                                <option value="{{ $salutation }}" @if($client->salutation == $salutation) selected @endif >@lang('app.'.$salutation)</option>
                            @endforeach
                        </x-forms.select>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.select fieldId="country" :fieldLabel="__('app.country')" fieldName="country"
                            ...
                            @foreach ($countries as $item)
                                <option data-tokens="{{ $item->iso3 }}" @if ($client->country_id == $item->id) selected @endif
                                    data-content="<span
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.select fieldId="gender" :fieldLabel="__('modules.employees.gender')"
                            fieldName="gender">
                            <option value="male" {{ $client->gender == 'male' ? 'selected' : '' }}>@lang('app.male')</option>
                            <option value="female" {{ $client->gender == 'female' ? 'selected' : '' }}>@lang('app.female')</option>
                            <option value="others" {{ $client->gender == 'others' ? 'selected' : '' }}>@lang('app.others')</option>
                        </x-forms.select>
                    </div>
                ...
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-top-grey">@lang('modules.client.companyDetails')</h4>
                <div class="row p-20">
                    <div class="col-lg-4 col-md-6">
                        <x-forms.text class="mb-3 mt-3 mt-lg-0 mt-md-0" fieldId="company_name"
                            ...
                            :fieldValue="$client->clientDetails->company_name" fieldPlaceholder="e.g. Space X">
                        </x-forms.text>
                    </div>
                    <div class="col-lg-4 col-md-6">
                                    ...
                                    @elseif($field->type == 'checkbox')
                                        <div class="form-group my-3">
                                            ...
                                            <div class="d-flex checkbox-{{$field->id}}">
                                                <input type="hidden" name="custom_fields_data[{{$field->name.'_'.$field->id}}]" id="{{$field->name.'_'.$field->id}}" value="{{$clientDetail->custom_fields_data['field_'.$field->id]}}">
