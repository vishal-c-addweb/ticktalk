        ...
        @forelse ($allModules as $key=>$module)
            <tr>
                ...
                <td>
                    @if (config(strtolower($module) . '.setting'))
                        <span
                            class="badge badge-secondary">{{ File::get($module->getPath() . '/version.txt') }}</span>
                    @endif
                </td>
                <td>
                    @if (config(strtolower($module) . '.setting'))
                ...
                <td class="text-right">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" @if (in_array($module, $worksuitePlugins)) checked @endif class="custom-control-input change-module-status"
