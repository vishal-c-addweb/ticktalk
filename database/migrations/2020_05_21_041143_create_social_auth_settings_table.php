...
class CreateSocialAuthSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('social_auth_settings', function (Blueprint $table) {
            ...
            $table->string('rocket_chat_client_id')->nullable();
            $table->string('rocket_chat_secret_secret_id')->nullable();
            $table->string('rocket_chat_redirect_uri')->nullable();
            $table->string('rocket_chat_server_uri')->nullable();
            $table->enum('rocket_chat_status', ['enable', 'disable'])->default('disable');
            $table->timestamps();
        });
